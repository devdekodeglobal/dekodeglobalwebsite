    ...
    customizedProposal.sections.forEach(sec => {
      if (sec.id !== 'business-plan') {
        sec.html = sec.html.replace(
          ...
          `<button class="sidebar-nav-btn ">Business Impact</button></div></div><div class="proposal-main-content">`
        )
      }
    })
  }
