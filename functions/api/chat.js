  ...
  const sendResult = (modelResult, payload = {}) => {
    ...
    return response.status(200).json({
      ...
      suggestions: (() => {
        ...
        let list = routeStarTrustSuggestion(result.suggestions, question, usedSuggestions);
